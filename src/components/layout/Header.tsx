...
import {
  ...
  Send, ExternalLink, Star, Shield, ChevronRight, Code, Car, Utensils
} from 'lucide-react'
...
export default function Header({ user }: HeaderProps) {
  ...
  return (
    <>
      ...
      <div className={`hidden lg:block bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white transition-all duration-300 ${scrolled ? 'h-0 opacity-0 overflow-hidden' : 'h-10'
        }`}>
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 lg:h-[70px]">
            ...
            <div className="hidden lg:flex items-center gap-1">
              <Link
                href="/"
                className={`relative px-4 py-2.5 rounded-lg transition-all font-medium text-sm ${isActive('/')
              ...
              <div className="relative" ref={qrMenuRef}>
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg transition-all font-medium text-sm ${qrMenuOpen || isQrPage
                    ? 'text-blue-600 bg-blue-50'
                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                    }`}
                >
              ...
              <Link
                ...
                className={`px-4 py-2.5 rounded-lg transition-all font-medium text-sm ${isActive('/features')
                  ? 'text-blue-600 bg-blue-50'
                  : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                  }`}
              >
              ...
              <Link
                ...
                className={`px-4 py-2.5 rounded-lg transition-all font-medium text-sm ${isActive('/pricing')
                  ? 'text-blue-600 bg-blue-50'
                  : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                  }`}
              >
              ...
              <Link
                ...
                className={`px-4 py-2.5 rounded-lg transition-all font-medium text-sm ${isActive('/contact')
                  ? 'text-blue-600 bg-blue-50'
                  : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                  }`}
              >
            ...
            <div className="lg:hidden flex items-center gap-3">
              <button
                ...
                className={`p-2.5 rounded-lg border transition-all ${mobileMenuOpen
            ...
            <div className="px-4 py-4 space-y-1">
              ...
              <div className="rounded-xl overflow-hidden">
                <button
                  ...
                  className={`flex items-center justify-between w-full px-4 py-3 font-medium transition-all rounded-xl ${mobileQrMenuOpen || isQrPage
                    ? 'bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-600'
                    : 'text-gray-700 hover:bg-gray-50'
                    }`}
                >
                  <span className="flex items-center gap-3">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${mobileQrMenuOpen || isQrPage ? 'bg-blue-100' : 'bg-gray-100'
                      }`}>
              ...
              <Link
                href={localizedHref('/features')}
                className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all ${isActive('/features')
                  ? 'bg-blue-50 text-blue-600'
                  : 'text-gray-700 hover:bg-gray-50'
                  }`}
                onClick={() => setMobileMenuOpen(false)}
              >
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${isActive('/features') ? 'bg-blue-100' : 'bg-gray-100'
                  }`}>
              ...
              <Link
                href={localizedHref('/pricing')}
                className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all ${isActive('/pricing')
                  ? 'bg-blue-50 text-blue-600'
                  : 'text-gray-700 hover:bg-gray-50'
                  }`}
                onClick={() => setMobileMenuOpen(false)}
              >
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${isActive('/pricing') ? 'bg-blue-100' : 'bg-gray-100'
                  }`}>
              ...
              <Link
                href={localizedHref('/contact')}
                className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all ${isActive('/contact')
                  ? 'bg-blue-50 text-blue-600'
                  : 'text-gray-700 hover:bg-gray-50'
                  }`}
                onClick={() => setMobileMenuOpen(false)}
              >
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${isActive('/contact') ? 'bg-blue-100' : 'bg-gray-100'
                  }`}>
              ...
              <div className="pt-4 mt-4 border-t border-gray-100">
                <div className="flex items-center justify-between px-4 py-3 bg-gray-50 rounded-xl">
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span className="text-sm font-medium">{currentLocale === 'tr' ? 'Dil' : 'Language'}</span>
                  </div>
                  <div className="flex gap-2">
                    <button
                      onClick={() => handleLanguageChange('tr')}
                      className={`px-3 py-1.5 text-sm font-medium rounded-lg transition-all ${currentLocale === 'tr'
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 text-sm font-medium rounded-lg transition-all ${currentLocale === 'en'
                        ? 'bg-blue-600 text-white'
                        : 'bg-white text-gray-600 border border-gray-200 hover:border-gray-300'
                        }`}
                    >
