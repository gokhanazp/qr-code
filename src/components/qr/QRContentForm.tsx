...
<body>
  ...
  <p>Bu bir örnek HTML sayfasıdır.</p>
      ...
      case 'PARKING':
        const labelColors = [
          { id: 'yellow', color: '#FFD700', name: locale === 'tr' ? 'Sarı' : 'Yellow' },
          { id: 'orange', color: '#FF8C00', name: locale === 'tr' ? 'Turuncu' : 'Orange' },
          { id: 'red', color: '#DC2626', name: locale === 'tr' ? 'Kırmızı' : 'Red' },
          { id: 'green', color: '#22C55E', name: locale === 'tr' ? 'Yeşil' : 'Green' },
          { id: 'blue', color: '#3B82F6', name: locale === 'tr' ? 'Mavi' : 'Blue' },
          { id: 'purple', color: '#8B5CF6', name: locale === 'tr' ? 'Mor' : 'Purple' },
          { id: 'pink', color: '#EC4899', name: locale === 'tr' ? 'Pembe' : 'Pink' },
          { id: 'white', color: '#F3F4F6', name: locale === 'tr' ? 'Beyaz' : 'White' },
        ]
        const labelShapes = [
          { id: 'rounded', name: locale === 'tr' ? 'Yuvarlatılmış' : 'Rounded' },
          { id: 'square', name: locale === 'tr' ? 'Kare' : 'Square' },
          { id: 'pill', name: locale === 'tr' ? 'Hap' : 'Pill' },
        ]
        return (
          <div className="space-y-4">
            {/* Telefon Numarası */}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {locale === 'tr' ? 'Etiket Rengi' : 'Label Color'}
              </label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {locale === 'tr' ? 'Etiket Şekli' : 'Label Shape'}
              </label>
              <div className="flex gap-2">
                {labelShapes.map((s) => (
                  <button
